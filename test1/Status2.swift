...
class Status2: UIViewController{
    var i = 0
    ...
    override func viewDidLoad() {
        ...
        myBackButton.setTitleColor(UIColor.blackColor(), forState: UIControlState.Normal)//black
        // コーナーの半径を設定する.
    ...
    func onClickMyBackButton(Sender: UIButton){
        ...
        let myBack: UIViewController = ACTViewController2()
