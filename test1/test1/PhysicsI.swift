...
class PhysicsI: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 背景に画像を設定する.
        let myImage = UIImage(named: "vi.png")!
        ...
        myButton3.setTitle("正解", forState: UIControlState.Normal)
        ...
        myButton3.setTitle("正解", forState: UIControlState.Highlighted)
        ...
        myButton3.addTarget(self, action: "onClickSeikaiButton:", forControlEvents: .TouchUpInside)
