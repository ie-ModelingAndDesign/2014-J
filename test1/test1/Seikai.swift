...
class Seikai1: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 背景に画像を設定する.
        let myImage = UIImage(named: "3.png")!
        ...
        myButtonX.setTitle("正解！", forState: UIControlState.Normal)
...
class Seikai2: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = UIColor.whiteColor()
        // 背景に画像を設定する.
        let myImage = UIImage(named: "17.png")!
        var myImageView = UIImageView()
